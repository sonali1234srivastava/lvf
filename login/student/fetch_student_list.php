...
$columns = array('id','name','number','email','course','branch','year','username','hostle_name','home_address', 'father_name','father_number','verify');
...
if(isset($_POST["search"]["value"]))
{
 ...
 OR hostle_name LIKE "%'.test_input($_POST["search"]["value"]).'%"
 ...
 OR verify LIKE "%'.test_input($_POST["search"]["value"]).'%"
 ';
}
...
$sub_array[] = '<div id="'.$row["id"].'" data-column="hostle_name">' . $row["hostle_name"] . '</div>';
